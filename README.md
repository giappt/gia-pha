...
- **Lõi Nghiệp Vụ (Kinship & Lunar Engine):** Thuật toán tìm Gốc Gần Nhất kết hợp bộ từ điển xưng hô cấu hình được; bộ quy đổi Âm - Dương chuẩn xác theo múi giờ Việt Nam (UTC+7).
