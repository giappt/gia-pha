...
const FEATURE_CONFIGS: FeatureFlagConfig[] = [
  ...
  },
  {
    ...
    title: 'Phân Hệ Lịch Giỗ Gia Tộc',
    icon: Calendar,
    description: 'Hiển thị Lịch Giỗ trên thanh điều hướng, trang chủ và danh sách ngày giỗ.',
    onDesc: 'Hiển thị mục Lịch Giỗ ngoài trang chủ và mở trang Lịch Giỗ cho con cháu tra cứu.',
    offDesc: 'Ẩn toàn bộ mục Lịch Giỗ ngoài trang chủ và thanh menu điều hướng.',
    safetyTag: 'An Toàn',
    tagColor: 'bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950 dark:text-emerald-300 dark:border-emerald-800',
  },
  {
    key: 'enable_push_notifications',
    title: 'Thông Báo Đẩy Web Push & Nhắc Giỗ',
    icon: Bell,
    description: 'Cho phép con cháu đăng ký nhận thông báo đẩy trên thiết bị và gửi nhắc giỗ tự động.',
    onDesc: 'Hiển thị chuông đăng ký thông báo đẩy và kích hoạt tiến trình gửi nhắc giỗ 7:00 sáng.',
    offDesc: 'Ẩn nút chuông đăng ký trên toàn trang và tạm dừng tiến trình gửi thông báo Web Push.',
    safetyTag: 'An Toàn',
    tagColor: 'bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950 dark:text-emerald-300 dark:border-emerald-800',
  },
  {
